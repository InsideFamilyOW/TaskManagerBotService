...
**ВАЖНО!** Проект использует `.env` файл для хранения конфиденциальных данных.
...
2. Откройте `.env` и заполните настоящие значения:
...
ADMIN_TG_ID=123456789,987654321        # Узнать свой ID можно у @userinfobot

# Database Configuration
DATABASE_URL=postgresql+asyncpg://user:password@host:port/database
```

**⚠️ НЕ ЗАГРУЖАЙТЕ `.env` файл в Git! Он уже добавлен в `.gitignore`**
...
1. Наличие и правильность заполнения `.env` файла
2. Логи в файле `Data/log.log`
